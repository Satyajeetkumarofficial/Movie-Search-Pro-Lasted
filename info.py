...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5715484543').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002376757650') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request File With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002459120948')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "MovieSearchProtechCloneFilterBot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'MovieSearchProCollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MovieSearchProGroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MovieSearchProUpdate')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MovieSearchProGroup') # Support Chat Link Without https:// or @
